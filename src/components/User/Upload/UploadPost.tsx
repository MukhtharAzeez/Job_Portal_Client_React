...
export function PostAddModal({ addPost, setAddPost }: Props) {
  ...
  // const S3_BUCKET = import.meta.env.VITE_REACT_APP_S3_BUCKET_NAME;
  // const accessKeyId = import.meta.env.VITE_REACT__APP_S3__ACCESS_KEY_ID;
  // const region = import.meta.env.VITE_REACT__APP_S3_REGION;
  // const secretAccessKey = import.meta.env.VITE_REACT__APP_S3_SECRET_ACCESS_KEY;
